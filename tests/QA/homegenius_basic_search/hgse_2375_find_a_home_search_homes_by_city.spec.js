...
const { logInHomegeniusUser, goToHomegenius, readFile} = require("../../../lib/node_20_helpers");
...
test("hgse_2375_find_a_home_search_homes_by_city", async () => {
 // Step 1. HGSE-2375: [Find-a-Home] Search Homes by City
  ...
  //--------------------------------
  // Constants
  const url = `${process.env.URL_HOMEGENIUS}/find-a-home`;
  ...
  // Accept cookies if cookies popup
  if ( await page.getByRole(`button`, { name: `Accept Cookies` }).count() > 0){
  ...
  await expect(async () => {
    ...
    //   'Chicago_regular', {maxDiffPixelRatio: 0.05}
    // )
 ...
 // Step 2. Extra Small  [Find-a-Home] Search Homes by City
  ...
  // Accept cookies if cookies popup
  if ( await page2.getByRole(`button`, { name: `Accept Cookies` }).count() > 0){
 ...
 // Step 3. Small  [Find-a-Home] Search Homes by City
  ...
  // Accept cookies if cookies popup
  if ( await page3.getByRole(`button`, { name: `Accept Cookies` }).count() > 0){
  ...
  await expect(async () => {
    await expect(page3.locator(`[id="deckgl-wrapper"]`)).toHaveScreenshot(
      'Chicago_small', {maxDiffPixelRatio: 0.05}
    )
  }).toPass({timeout: 30_000})
 ...
 // Step 4. Medium  [Find-a-Home] Search Homes by City
  ...
  // Accept cookies if cookies popup
  if ( await page4.getByRole(`button`, { name: `Accept Cookies` }).count() > 0){
  ...
  await expect(async () => {
    await expect(page4.locator(`[id="deckgl-wrapper"]`)).toHaveScreenshot(
      'Chicago_medium', {maxDiffPixelRatio: 0.05}
    )
  }).toPass({timeout: 30_000})
 ...
 // Step 5. Large  [Find-a-Home] Search Homes by City
  ...
  // Accept cookies if cookies popup
  if ( await page5.getByRole(`button`, { name: `Accept Cookies` }).count() > 0){
  ...
  await expect(async () => {
    await expect(page5.locator(`[id="deckgl-wrapper"]`)).toHaveScreenshot(
      'Chicago_large', {maxDiffPixelRatio: 0.05}
    )
  }).toPass({timeout: 30_000})
 ...
 // Step 6. Extra Large  [Find-a-Home] Search Homes by City
  ...
  // Accept cookies if cookies popup
  if ( await page6.getByRole(`button`, { name: `Accept Cookies` }).count() > 0){
  ...
  await expect(async () => {
    await expect(page6.locator(`[id="deckgl-wrapper"]`)).toHaveScreenshot(
      'Chicago_extraLarge', {maxDiffPixelRatio: 0.05}
    )
  }).toPass({timeout: 30_000})
 ...
 // Step 7. 1x Large  [Find-a-Home] Search Homes by City
  ...
  // Accept cookies if cookies popup
  if ( await page7.getByRole(`button`, { name: `Accept Cookies` }).count() > 0){
  ...
  await expect(async () => {
    await expect(page7.locator(`[id="deckgl-wrapper"]`)).toHaveScreenshot(
      'Chicago_1extraLarge', {maxDiffPixelRatio: 0.05}
    )
  }).toPass({timeout: 30_000})
