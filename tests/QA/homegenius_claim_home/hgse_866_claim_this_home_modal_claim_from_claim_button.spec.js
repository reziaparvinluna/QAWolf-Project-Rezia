...
test("hgse_866_claim_this_home_modal_claim_from_claim_button", async () => {
 // Step 1. HGSE-866: Claim This Home Modal. Claim from Claim Button.
  ...
  const searchAddress = {
    searchAddress: "233 Park Lane, Hendersonville, NC 28791",
    searchAddr2: "233 Park Ln",
    addressLineOne: "233 Park Lane",
  ...
  await expect(page.locator(`p:has-text("${searchAddress.searchAddr2}") >>nth=0`)).toBeVisible()
